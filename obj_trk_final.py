...
def drawbox(img,bbox):
    ...
    cv2.putText(img,"Tracking",(100,100),cv2.FONT_HERSHEY_SCRIPT_COMPLEX,1,(0,0,255),2) 
...
while True:
    ...
    if succes:
        ...
        cv2.putText(img,"lost",(100,100),cv2.FONT_HERSHEY_SCRIPT_COMPLEX,0.7,(0,0,255),2) 
